...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    slug: "masala-chana",
    name: "Masala Chana",
    short: "Spicy fry chickpeas",
    description: "Fry whole chickpeas with bold red masala — a protein-rich snack.",
    image: masalaChana,
    variants: scaled(200, 180, "200g"),
    category: "regular",
  },
  ...
  // ============ PEANUTS ============
  {
    slug: "peanut-red",
    name: "Red Peanut",
    short: "Fry red-skin peanuts",
    description: "Premium red-skin fry peanuts — earthy, nutty and protein-rich.",
    image: peanutRed,
    variants: scaled(200, 240, "200g"),
    category: "peanuts",
  },
  {
    slug: "peanut-salty",
    name: "Salty Peanut",
    short: "Lightly salted fry peanuts",
    description: "Fry golden peanuts with a perfect light salt finish.",
    image: peanutSalty,
    variants: scaled(200, 240, "200g"),
    category: "peanuts",
  },
  {
    slug: "peanut-masala",
    name: "Spicy Peanut",
    short: "Spicy fry peanuts",
    description: "Fry peanuts coated in our fiery red chili masala.",
    image: peanutMasala,
    variants: scaled(200, 240, "200g"),
    category: "peanuts",
  },
